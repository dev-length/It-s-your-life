function addContac1({ name, phone, email = '이메일없음', age = '0' }) {
  console.log(name, phone, email, age);
}
addContac1({ name: '이몽룡', phone: '010-3434-8989' });
...
function addContac3(name, phone, email = `이메일없음`, age = `0`) {
  console.log(name, phone, email, age);
}
addContac3('이몽룡', '010-3434-8989');
